...
if __name__ == "__main__":
    # text requests
    trt = TextRequestTests("http://localhost:3000/api/text/2/20", "http://localhost:3000/api/text",
                           "http://localhost:3000/api/text/11")
    ...
    trt.interpret_response(get_text_by_id_request)
      ...
      # Translation Responses
        ...
        trr.interpret_response(get_all_response)
